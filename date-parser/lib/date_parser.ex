defmodule DateParser do
  ...
  def day_names(),
    do: "(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday)"
  ...
  def capture_day_month_name_date(),
    do: "(#{capture_day_name()}, #{capture_month_name_date()})"

  def match_numeric_date(),
    do: ~r"^#{capture_numeric_date()}$"

  def match_month_name_date(),
    do: ~r"^#{capture_month_name_date()}$"

  def match_day_month_name_date(),
    do: ~r"^#{capture_day_month_name_date()}$"
end
